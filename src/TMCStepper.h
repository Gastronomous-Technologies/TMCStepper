...
class TMC2130Stepper : public TMCStepper {
	public:
		TMC2130Stepper(SPIClass& spi, uint16_t pinCS, float RS = default_RS, int8_t link_index = -1);
...
class TMC2160Stepper : public TMC2130Stepper {
	public:
		TMC2160Stepper(SPIClass& spi, uint16_t pinCS, float RS = default_RS, int8_t link_index = -1);
...
class TMC5130Stepper : public TMC2160Stepper {
	public:
		TMC5130Stepper(SPIClass& spi , uint16_t pinCS, float RS = default_RS, int8_t link_index = -1);
...
class TMC5160Stepper : public TMC5130Stepper {
	public:
		TMC5160Stepper(SPIClass& spi, uint16_t pinCS, float RS = default_RS, int8_t link_index = -1);
...
class TMC5161Stepper : public TMC5160Stepper {
	public:
    TMC5161Stepper(SPIClass& spi, uint16_t pinCS, float RS = default_RS, int8_t link_index = -1) : TMC5160Stepper(spi, pinCS, RS, link_index) {}
